(function ()
{
    ...
    /** @ngInject */
    function RequestsController($scope, $rootScope, $document, $mdDialog, $mdMedia, $mdSidenav, $state, msApi, Folders, Labels)
    {
        var vm = this;
        ...
        function openThread(thread)
        {
            ...
            // Update the state without reloading the controller
            $state.go('app.requests.threads.thread', {threadId: thread.id}, {notify: false});
        }
